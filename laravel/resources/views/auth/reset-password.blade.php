...
@section('form')
<div>
    <h2 class="text-2xl font-extrabold text-gray-900 mb-1">Set a new password</h2>
    <p class="text-gray-500 text-sm mb-8">Your new password must be at least 8 characters and contain uppercase, lowercase, a number, and a symbol.</p>
        ...
        <div>
            ...
            <div class="relative">
                <input :type="showPwd ? 'text' : 'password'" name="password" required
                       class="w-full px-4 py-3 pr-11 rounded-xl border {{ $errors->has('password') ? 'border-red-400 bg-red-50' : 'border-gray-300' }} text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
