...
<section class="section team-section" id="team">
  <div class="container">
    <div class="team-grid">
      ...
      <div class="team-card reveal reveal-delay-1"><div class="team-avatar">IB</div><div><div class="team-name">Itai Bonda</div><div class="team-role">Corporate Trainer</div><p class="team-bio">A seasoned corporate trainer and certified labour consultant with over 15 years delivering top-drawer training services across public and private sector organisations in Zimbabwe. Itai is a published author in Industrial Relations and lectures part-time at the University of Zimbabwe. He ensures that every training programme we deliver meets the highest standards of adult learning design and facilitation excellence.</p><div class="team-creds"><span class="cred-tag">MBA, University of Zimbabwe</span><span class="cred-tag">Certified Labour Consultant</span><span class="cred-tag">Published Author, IR</span></div></div></div>
    </div>
  </div>
</section>
