...
<section class="section clients-section" id="clients">
  <div class="container">
    <p class="eyebrow reveal">Industry Pedigree</p>
    <h2 class="display reveal" style="margin-top:12px;max-width:600px;">Trusted By Leading Institutions Across Zimbabwe &amp; East Africa</h2>
    <p class="lead reveal" style="max-width:580px;margin-top:16px;">Our frameworks have been deployed with government authorities, regulatory bodies, universities, and high-profile private sector organisations.</p>
